...
flowchart_train_set, flowchart_val_set = read_train_val_sets('object_detection/data/flowchart_train.txt')
math_train_set, math_val_set = read_train_val_sets('object_detection/data/math_train.txt')

flowchart_test_set = read_test_set('object_detection/data/flowchart_test.txt')
math_test_set = read_test_set('object_detection/data/math_test.txt')
